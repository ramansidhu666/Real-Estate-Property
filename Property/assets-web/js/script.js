...
$document.ready(function () {
    ...
    plugins.examdate.datetimepicker({
        //language: 'id',
        weekStart: 1,
        todayBtn: 1,
        autoclose: 1,
    ...
    plugins.dateofbirth.datetimepicker({
        //language: 'ca',
        weekStart: 1,
        todayBtn: 1,
        autoclose: 1,
    ...
    plugins.examtime.datetimepicker({
        //language: 'fr',
        weekStart: 1,
        todayBtn: 1,
        autoclose: 1,
    ...
    //popup modal
    plugins.popup_mdl.click(function () {
        
        plugins.modl_id.modal('toggle')
    })
            ...
            onInit: function (map) {
              ...
              if (inputAddress.length) {
                ...
                var marker = new google.maps.Marker(
                    {
                      map: map,
                      icon: "/assets-web/images/gmap_marker.png",
                    }
                );
